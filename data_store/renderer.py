__author__ = "mstacy"
from rest_framework.renderers import BrowsableAPIRenderer  # , #JSONPRenderer
...
class mongoJSONPRenderer(mongoJSONRenderer):
    ...
    def render(self, data, accepted_media_type=None, renderer_context=None):
        ...
        json = super(mongoJSONPRenderer, self).render(data, accepted_media_type, renderer_context)
